...
<table>
	...
	<tr>
		...
		<c:if test="${documents.teamLeader eq 'Y'}">
	...
	<tr>
		<td>
			<input type="text" id="documentsItem2" name="documentsItem2" class="documentsItem" value="${documents.documentsItem2}" readonly="readonly">
		</td>
		<td colspan="5">
			<input type="text" id="documentsContent2" name="documentsContent2" class="documentsContent" readonly="readonly" value="${documents.documentsContent2}">
		</td>
	</tr>
	<tr>
		<td>
