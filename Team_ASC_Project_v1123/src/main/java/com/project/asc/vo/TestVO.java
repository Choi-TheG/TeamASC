...
public class TestVO {
	...
	public TestVO(int testSeq, int projectSeq, String program, String customer, String manager, int scenarioNo,
	...
	public String toString() {
		return "TestVO [testSeq=" + testSeq + ", projectSeq=" + projectSeq + ", program=" + program + ", customer="
